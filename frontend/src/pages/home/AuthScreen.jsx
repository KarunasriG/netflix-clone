...
const AuthScreen = () => {
    ...
    return (
         ...
         <div className="hero-bg relative">
             {/* Navbar */}
         <header className="relative max-w-6xl mx-auto flex items-center justify-between p-4 pb-10">
            <img src="/netflix-logo.png" alt="Netflix Logo" className="w-32 md:w-52" />
            <Link to={"/login"} className='text-white bg-red-600 py-2 px-4 rounded hover:bg-red-700 transition duration-300'> Sign In</Link>
         </header>
         {/* hero section */}
         <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-100px)] text-center px-4 text-white max-w-4xl mx-auto">
            ...
            <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleSubmit}>
             <input type="email" placeholder="Email address" className="p-2 rounded flex-1 bg-black/8- border border-gray-700" value={email} onChange={(e)=>setEmail(e.target.value)} />
             <button className="bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 md:py-2 rounded flex justify-center items-center">Get Started 
                <ChevronRightIcon className="size-8 md:size-10" />
             </button>
            </form>
         </div>
...
<div className='py-10 bg-black text-white'>
 <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row px-4 md:px-2'>
       {/* left side */}
       <div className='flex-1 text-center md:text-left'>
    ...
    <div className="flex-1 relative overflow-hidden">
                    ...
                    <video className='absolute top-12 left-1/2 -translate-x-1/2 h-1/2 z-10 max-w-[63%]' autoPlay loop muted playsInline>
